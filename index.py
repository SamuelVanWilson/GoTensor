...
emotion_model = tf.keras.models.load_model('model/emotion_detector_model.keras', compile=False)
...
# style_model = tf.keras.models.load_model('model/style_transfer_model.keras', compile=False)
...
#         return render_template('style_transfer.html', result=result_filename)
